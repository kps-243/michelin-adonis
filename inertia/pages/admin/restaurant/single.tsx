    ...
    <div className="min-h-screen bg-[#EFEFEF] dark:bg-gray-900 pb-24 transition-colors">
      ...
      <div className="bg-white dark:bg-gray-900 shadow-sm sticky top-0 z-40 border-b border-transparent dark:border-gray-700">
        <div className="px-4 py-3 flex items-center gap-3 lg:max-w-5xl lg:mx-auto lg:px-8 lg:py-4">
          ...
          <h1 className="font-title text-[18px] lg:text-[22px] font-semibold flex-1 truncate dark:text-white">{r.name}</h1>
          <Link
      ...
      <div className="px-4 py-5 flex flex-col gap-4 lg:max-w-5xl lg:mx-auto lg:px-8 lg:grid lg:grid-cols-2 lg:items-start">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm">
          ...
          <div className="mt-3 flex flex-col gap-1.5 text-[13px] text-gray-600 dark:text-gray-300">
            <p>{r.street}</p>
            <p>{r.postcode} {r.city}</p>
            <p className="font-medium text-gray-900 dark:text-white">{r.country}</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm">
          ...
          <div className="mt-3 grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="font-mono text-[13px] text-gray-900 dark:text-gray-100">{r.lat}</p>
            </div>
            <div>
              <p className="text-[10px] uppercase tracking-wider text-gray-400 mb-1">Longitude</p>
              <p className="font-mono text-[13px] text-gray-900 dark:text-gray-100">{r.lng}</p>
            </div>
          </div>
          <a
        ...
        <div className="flex gap-3 lg:col-span-2">
          <Link
            href={`/admin/restaurants/${r.id}/edit`}
            className="flex-1 py-3.5 text-center rounded-2xl border-[1.5px] border-gray-900 dark:border-gray-400 text-gray-900 dark:text-gray-200 text-[13px] font-semibold hover:bg-gray-900 dark:hover:bg-gray-700 hover:text-white transition-colors"
          >
            Modifier
          </Link>
          <button
